  ...
  constructor() {
    ...
    this.dictionaries = {
      pt: {
        ...
        'tts_title': 'Sintetizador de Voz (TTS)', 'listen_page': 'Ouvir Página (TTS)', 'pause_audio': 'Pausar Áudio',
      ...
      en: {
        ...
        'tts_title': 'Text-to-Speech (TTS)', 'listen_page': 'Listen to Page (TTS)', 'pause_audio': 'Pause Audio',
      ...
      es: {
        ...
        'tts_title': 'Sintetizador de Voz (TTS)', 'listen_page': 'Escuchar página (TTS)', 'pause_audio': 'Pausar audio',
